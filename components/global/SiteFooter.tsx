            ...
            <div className="flex gap-2">
              {SOCIAL.map((s) => (
                <a
                  ...
                  aria-label={s.name}
                  className="flex size-9 items-center justify-center border border-white/15 text-white/70 transition-colors hover:border-ppa-blue hover:bg-ppa-blue hover:text-white"
                >
                  <svg
                    viewBox="0 0 24 24"
                    className="size-4"
