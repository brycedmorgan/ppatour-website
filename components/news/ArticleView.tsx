...
/**
 * The article page itself, shared by the two routes that serve one archive:
 * `app/[slug]` for the 811 migrated posts + 15 native articles at the root, and
 * `app/ppa-blog/[slug]` for the 39 evergreen blog posts under their own prefix.
 *
 * It lives here rather than in either route because the two URL shapes are a
 * WordPress inheritance, not a design difference — a reader cannot tell them
 * apart and neither should the code. Route-level concerns (which slugs
        ...
        <div className="mx-auto w-full max-w-6xl px-4 py-10">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-2.5">
              <span className="h-2 w-2 bg-ppa-blue" />
              <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-ppa-navy/50">
                {isBlog ? "More From the Blog" : "More From the Tour"}
              </p>
            </div>
            <Link
