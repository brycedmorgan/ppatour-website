...
| Item | State | Blocker |
|---|---|---|
| **SEO plan** | **PLANNED 9/23** — full-crawl findings, 13 Phase-1 code fixes, 12 evergreen pillars, dated checkpoints: [`SEO.md`](SEO.md) | Bryce: GSC access, SEMrush API seat, GA4 hostname split (Phase 0) |
