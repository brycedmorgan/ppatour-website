...
export const eventBroadcasts: Record<string, BroadcastSlot[]> = {
  ...
  "veolia-malibu-cup": [
    ...
    { round: "SF's", day: "Saturday", window: "12PM ET - 8PM ET", platform: "PBTV", type: "LIVE" },
    { round: "SF's", day: "Saturday", window: "3PM ET - 7PM ET", platform: "Tennis Channel", secondary: "PBTV", type: "LIVE" },
    { round: "Championship", day: "Sunday", window: "1PM ET - 7PM ET", platform: "PBTV", type: "LIVE" },
    { round: "Championship", day: "Sunday", window: "3PM ET - 7PM ET", platform: "Tennis Channel", secondary: "PBTV", type: "LIVE" },
  ],
